var IssueTagsInputView = Ember.View.extend({
    tagName: 'section',
    elementId: 'issue-tags',
    classNames: 'issue-tags-input-container',

    templateName: 'issue-tags-input',
    ...
    tagInputView: Ember.TextField.extend({
        ...
        focusOut: function () {
            ...
            this.get('parentView.controller').send('setTags');
        },
...
export default IssueTagsInputView;
