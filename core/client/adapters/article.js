...
var ArticleAdapter = EmbeddedRelationAdapter.extend({
    createRecord: function (store, type, record) {
        ...
        // use the ArticleSerializer to transform the model back into
        // an array with a article object like the API expects
    ...
    updateRecord: function (store, type, record) {
        ...
        // use the ArticleSerializer to transform the model back into
        // an array of articles objects like the API expects
        serializer.serializeIntoHash(data, type, record);
